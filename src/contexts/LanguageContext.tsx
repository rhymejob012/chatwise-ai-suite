...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'pricing.fullpack.features': 'Расшифровка аудио сообщений|Проверка чека|Уведомления админа|CRM система|+2 бесплатных тех обслуживания',
    'pricing.included': 'Подключаемые функции:',
    ...
    'pricing.social.title': 'Для соц сетей:',
  ...
  kz: {
    ...
    'pricing.fullpack.features': 'Аудио хабарламаларды шифрлау|Чекті тексеру|Админ хабарландырулары|CRM жүйесі|+2 тегін техникалық қызмет көрсету',
    'pricing.included': 'Қосылатын функциялар:',
    ...
    'pricing.addon.comments': 'Ыстық сөздер бойынша комментарийлерге жауап беру',
    'pricing.addon.files': 'Жазылым шартымен ыстық сөздер бойынша файл жіберу',
    'pricing.social.title': 'Әлеуметтік желілер үшін:',
    'pricing.note1': 'Бірінші техникалық қызмет көрсету тегін, содан кейін 10 000 ₸',
  ...
  en: {
    ...
    'pricing.fullpack.features': 'Audio message transcription|Receipt verification|Admin notifications|CRM system|+2 free maintenance services',
    ...
    'pricing.social.title': 'For social media:',
