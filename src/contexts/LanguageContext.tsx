...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'pricing.note1': 'Первое обслуживание бесплатно, далее 5 000 ₸/мес',
    'pricing.note2': 'Стоимость работы AI: $25–40/мес (списывается с карты клиента, не входит в тариф)',
    'pricing.each': 'каждая',
  ...
  kz: {
    ...
    'pricing.note1': 'Бірінші қызмет көрсету тегін, содан кейін 5 000 ₸/ай',
    'pricing.note2': 'AI жұмыс құны: $25–40/ай (клиент картасынан шегеріледі, тарифке кірмейді)',
  ...
  en: {
    ...
    'pricing.note1': 'First service is free, then 5,000 ₸/month',
    'pricing.note2': 'AI operation cost: $25–40/month (charged to client\'s card, not included in tariff)',
    'pricing.each': 'each',
